...
d3.scaleQuantize()
  ...
  main.variable(observer("countyName")).define("countyName", ["d3"], function(d3){return(
...
function hideTooltip(){
  ...
  main.variable(observer("showTooltip")).define("showTooltip", ["d3","rateById","countyName"], function(d3,rateById,countyName){return(
  ...
  main.variable(observer("tooltip")).define("tooltip", ["d3"], function(d3)
{
  ...
  let node = d3.select("body")
    ...
    .attr("class", "hidden")
    .append("p")
    .html("<b><span id='county_name'></b></span><br/>Taxa de desemprego: <span id='taxa'></span>%")
  return node
}
);
